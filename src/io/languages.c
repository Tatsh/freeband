...
bool languages_loadLanguage(ushort lang) {
    ...
    case en_GB:
        ...
        if ((lang_d = iniparser_load(languageIni)) == NULL) {
            ...
            fprintf(stdout,
                    "Successfully opened English-Commonwealth language file: %s.\n",
                    languageIni);
#endif
        break;
    ...
    languageStrings_screenMain.options =
        iniparser_getstring(lang_d, "screenMain:options", INIERROR);
    ...
    /* screenSongs */
    languageStrings_screenSongs.header =
        iniparser_getstring(lang_d, "screenSongs:header", INIERROR);
    ...
    /* screenPause */
    languageStrings_screenPause.header =
        iniparser_getstring(lang_d, "screenPause:header", INIERROR);
    ...
    languageStrings_screenPause.resume =
        iniparser_getstring(lang_d, "screenPause:resume", INIERROR);
