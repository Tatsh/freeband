...
GLfloat selectedGradientX[4];
GLfloat selectedGradientY[4];

GLfloat text_GuitarX[] = { 0.35f, 0.35f, 0.95f, 0.95f }; /* Guitar selector's default position */
GLfloat text_GuitarY[] = { -0.38f, -0.2f, -0.2f, -0.38f }; /* Use this as basis to calculate the other Y coordinates */
GLfloat text_BassX[] = { 0.45f, 0.45f, 0.85f, 0.85f };
GLfloat text_BassY[4];
GLfloat text_DrumsX[] = { 0.4f, 0.4f, 0.92f, 0.92f };
GLfloat text_DrumsY[4];
GLfloat text_VocalsX[] = { 0.34f, 0.34f, 0.98f, 0.98f };
